...
@Component({
  ...
  template: `
    ...
    <div class="w-screen h-screen overflow-auto dark:bg-primary backdrop-blur-lg bg-clean" [ngClass]="{'flex': sidebarFixed}">

      <sidebar *ngIf="!isLogin && !hideNav"></sidebar>

      <div class="relative w-full overflow-auto" [ngClass]="{'sm:pl-14 pl-0 ': !isLogin && !hideNav}">
