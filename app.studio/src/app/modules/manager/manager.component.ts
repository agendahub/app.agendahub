...
@Component({
  ...
  template: `
  <div class="bg-blend-hue bg-opacity-50 bg-slate-900 text-white mx-auto max-w-7xl sm:px-6 lg:px-8 sm:py-2 lg:py-4 p-3 lg:rounded-lg md:rounded-md rounded-none min-h-[calc(80vh)] max-h-screen" >
    <div class="w-50">
